...
namespace Microsoft.AspNet.Mvc.Routing
{
    public static class AttributeRouting
    {
                ...
                var allErrors = string.Join(
                    ...
                    errors.Select(
                        e => Resources.FormatAttributeRoute_IndividualErrorMessage(
                            GetFriendlyActionDescriptorName(e.ActionDescriptor), 
                            Environment.NewLine, 
                            e.ErrorMessage)));
        ...
        private static string GetFriendlyActionDescriptorName(ActionDescriptor action)
        {
            ...
            else
            {
                return string.Format(
                    "{0}.{1}",
                    reflectedActionDescriptor.MethodInfo.DeclaringType.FullName,
