...
namespace Microsoft.AspNet.Mvc
{
    public class ObjectResult : ActionResult
    {
                                                       ...
                                                       IEnumerable<IOutputFormatter> formatters)
        {
            ...
            var acceptHeaderMediaTypes = GetAcceptHeaders(formatterContext);
            ...
            if (ContentTypes == null || ContentTypes.Count == 0)
            {
                ...
                if (!acceptHeaderMediaTypes.Any() && requestContentType == null)
                {
            ...
            else
            {
                if (acceptHeaderMediaTypes.Any())
                {
                    ...
                    var filteredAndSortedAcceptHeaders = acceptHeaderMediaTypes
                                                                    .Where(acceptHeader =>
                                                                            ContentTypes
                                                                                .Any(contentType =>
        ...
        public virtual IEnumerable<MediaTypeHeaderValue> GetAcceptHeaders(OutputFormatterContext formatterContext)
        {
