...
namespace Microsoft.AspNetCore.Mvc.Analyzers
{
    public abstract class ApiControllerAnalyzerBase : DiagnosticAnalyzer
    {
        ...
        public sealed override void Initialize(AnalysisContext context)
        {
            ...
            {
                var ApiControllerAnalyzerContext = new ApiControllerAnalyzerContext(compilationContext);

                // Only do work if ApiControllerAttribute is defined.
                if (ApiControllerAnalyzerContext.ApiControllerAttribute == null)
                {
                    return;
                }

                InitializeWorker(ApiControllerAnalyzerContext);
            });
        }

        protected abstract void InitializeWorker(ApiControllerAnalyzerContext ApiControllerAnalyzerContext);
    }
}
