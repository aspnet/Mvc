...
namespace Microsoft.AspNetCore.Mvc.RazorPages.Internal
{
    public class PageActionInvoker : ResourceInvoker, IActionInvoker
    {
        ...
        protected override async Task InvokeInnerFilterAsync()
        {
            ...
            // communicate a result. The outermost scope is `Scope.Resource` and doesn't require any type
        ...
        {
            if (_model != null && _cacheEntry.ReleaseModel != null)
            {
                _cacheEntry.ReleaseModel(_pageContext, _model);
            }

            if (_page != null && _cacheEntry.ReleasePage != null)
            {
                _cacheEntry.ReleasePage(_pageContext, _page);
            }
        }
        ...
        private async Task ExecutePageAsync()
        {
            ...
            _page = (Page)_cacheEntry.PageFactory(_pageContext);
            ...
            {
                _model = _cacheEntry.ModelFactory(_pageContext);
            }
