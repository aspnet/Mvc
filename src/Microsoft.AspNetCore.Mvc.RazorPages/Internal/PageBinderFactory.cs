...
{
    public static class PageBinderFactory
    {
            ...
            CompiledPageActionDescriptor actionDescriptor)
        {
            ...
            var propertyBindingInfo = new PageParameterBindingInfo[properties.Count];
            for (var i = 0; i < properties.Count; i++)
            {
                ...
                propertyBindingInfo[i] = new PageParameterBindingInfo(binder, metadata);
            }
            ...
            HandlerMethodDescriptor handler)
        {
            ...
            var handlerType = actionDescriptor.HandlerTypeInfo.AsType();
            var parameterBindingInfo = new PageParameterBindingInfo[handler.Parameters.Count];
            for (var i = 0; i < parameterBindingInfo.Length; i++)
            {
                ...
                parameterBindingInfo[i] = new PageParameterBindingInfo(binder, metadata);
            }
        ...
        private struct PageParameterBindingInfo
        {
            public PageParameterBindingInfo(IModelBinder modelBinder, ModelMetadata modelMetadata)
            {
