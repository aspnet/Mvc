...
using Microsoft.AspNetCore.Mvc.RazorPages.Infrastructur;
...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class MvcRazorPagesMvcCoreBuilderExtensions
    {
        ...
        internal static void AddServices(IServiceCollection services)
        {
            ...
            services.TryAddEnumerable(
                ServiceDescriptor.Transient<IConfigureOptions<RazorViewEngineOptions>, MvcRazorPagesRazorViewEngineOptionsSetup>());
