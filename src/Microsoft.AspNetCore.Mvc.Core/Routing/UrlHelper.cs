...
namespace Microsoft.AspNetCore.Mvc.Routing
{
    ...
    public class UrlHelper : IUrlHelper
    {
        ...
        public UrlHelper(ActionContext actionContext, ILinkGenerator linkGenerator)
            : this(actionContext)
        {
        ...
        public virtual string Action(UrlActionContext actionContext)
        {
            ...
            {
                var canGetLink = _linkGenerator.TryGetLink(
                ...
                return GenerateUrl(actionContext.Protocol, actionContext.Host, link, actionContext.Fragment);
            }
        }
        ...
        internal void AppendPathAndFragment(StringBuilder builder, string virtualPath, string fragment)
        {
        ...
        protected virtual string GenerateUrl(string protocol, string host, string virtualPath, string fragment)
        {
            if (virtualPath == null)
            {
                return null;
