...
{
    /// <summary>
    /// An <see cref="ObjectResult"/> that on execution invokes <see cref="M:AuthenticationManager.ForbidAsync"/>.
    /// </summary>
    public class ForbidObjectResult : ObjectResult
    {
        ...
        public override async Task ExecuteResultAsync(ActionContext context)
        {
            ...
            var logger = loggerFactory.CreateLogger<ForbidObjectResult>();
