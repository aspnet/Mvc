...
{
    public class ApplicationEndpointConventionBuilder : IEndpointConventionBuilder
    {
        private readonly List<EndpointDataSource> _dataSources;

        internal ApplicationEndpointConventionBuilder(List<EndpointDataSource> dataSources)
        {
            if (dataSources == null)
            {
