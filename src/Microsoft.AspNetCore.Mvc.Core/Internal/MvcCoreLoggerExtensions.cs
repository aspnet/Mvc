...
namespace Microsoft.AspNetCore.Mvc.Internal
{
    internal static class MvcCoreLoggerExtensions
    {
        ...
        public static void ActionMethodExecuting(this ILogger logger, ActionContext context, object[] arguments)
        {
            if (logger.IsEnabled(LogLevel.Information))
            {
        ...
        public static void ActionMethodExecuted(this ILogger logger, ActionContext context, IActionResult result)
        {
