...
namespace Microsoft.AspNet.Mvc.Razor.Directives
{
    ...
    public class DefaultCodeTreeCache : ICodeTreeCache
    {
        ...
        private static readonly TimeSpan _slidingExpirationDuration = TimeSpan.FromMinutes(1);
        ...
        public DefaultCodeTreeCache(IFileProvider fileProvider)
            : this(fileProvider, _memoryCacheOptions)
        {
        }
        ...
        {
            return _codeTreeCache.GetOrSet(pagePath,
                                           getCodeTree,
                                           OnCacheMiss);
        }
        ...
        private CodeTree OnCacheMiss(ICacheSetContext cacheSetContext)
        {
            ...
            cacheSetContext.SetSlidingExpiration(_slidingExpirationDuration);
