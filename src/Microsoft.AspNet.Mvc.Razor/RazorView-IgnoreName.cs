...
namespace Microsoft.AspNet.Mvc.Razor
{
    ...
    public class RazorView : IView
    {
        ...
        private async Task<string> RenderPageAsync(RazorPage page, ViewContext context)
        {
        ...
        private async Task RenderPageCoreAsync(RazorPage page, ViewContext context)
        {
