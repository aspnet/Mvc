...
namespace Microsoft.AspNet.Mvc.Razor
{
    ...
    public abstract class RazorPage : IRazorPage
    {
                                             ...
                                             params AttributeValue[] values)
        {
            ...
            else
            {
                for (var i = 0; i < values.Length; i++)
                {
                    ...
                    PageExecutionContext.BeginContext(attrVal.Value.Position, sourceLength, isLiteral: attrVal.Literal);
        ...
        {
            PageExecutionContext.BeginContext(position, value.Length, isLiteral: true);
