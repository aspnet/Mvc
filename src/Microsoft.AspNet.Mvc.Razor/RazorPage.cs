...
namespace Microsoft.AspNet.Mvc.Razor
{
    ...
    public abstract class RazorPage : IRazorPage
    {
        ...
        /// <remarks>The value returned is a token value that allows FlushAsync to  to work directly in the
        /// an HTML section. However the value does not represent the rendered content.</remarks>
