...
namespace Microsoft.AspNet.Mvc.ModelBinding
{
    ...
    public abstract class CachedModelMetadata<TPrototypeCache> : ModelMetadata
    {
        ...
        public sealed override bool IsFromBody
        {
            get
            {
                if (!_isFromBody.HasValue)
                {
                    _isFromBody = ComputeIsFromBody();
                }
                return _isFromBody.Value;
            }
            set
            {
                base.IsFromBody = value;
            }
        }
