...
namespace Microsoft.AspNet.Mvc.ModelBinding
{
    public class CachedDataAnnotationsMetadataAttributes
    {
        public CachedDataAnnotationsMetadataAttributes(IEnumerable<Attribute> attributes)
        {
            ...
            BodyAttribute = attributes.OfType<MustBeReadFromRequestBodyAttribute>().FirstOrDefault();
        }
        ...
        public MustBeReadFromRequestBodyAttribute BodyAttribute { get; protected set; }
    }
}
