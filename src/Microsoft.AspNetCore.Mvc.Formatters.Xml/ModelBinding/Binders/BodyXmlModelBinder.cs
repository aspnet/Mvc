...
namespace Microsoft.AspNetCore.Mvc.ModelBinding.Binders
{
    ...
    /// </summary>
    public class BodyXmlModelBinder : BodyModelBinder// IModelBinder
    {
        ...
        /// </param>
        public BodyXmlModelBinder(IHttpRequestStreamReaderFactory readerFactory) : base(new List<IInputFormatter>() { new XmlSerializerInputFormatter() }, readerFactory)
        {
        }
