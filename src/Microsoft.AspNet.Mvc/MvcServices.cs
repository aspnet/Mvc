...
namespace Microsoft.AspNet.Mvc
{
    public class MvcServices
    {
        public static IServiceCollection GetDefaultServices()
        {
            ...
            services.AddTransient<IActionInvokerProvider,
                                            ControllerActionInvokerProvider>();

            services.AddSingleton<IActionDescriptorsCollectionProvider,
            ...
            services.AddSingleton<IModelMetadataProvider, DataAnnotationsModelMetadataProvider>();
            ...
            services.AddTransient<IValidationExcludeFiltersProvider,
