...
namespace Microsoft.AspNet.Mvc
{
    ...
    public class MvcOptionsSetup : ConfigureOptions<MvcOptions>
    {
        ...
        public static void ConfigureMvcOptions(MvcOptions options)
        {
            ...
            options.ModelMetadataProviders.Add(new DefaultModelMetadataBindingDetailsProvider());
            options.ModelMetadataProviders.Add(new DataAnnotationsModelMetadataDetailsProvider());
