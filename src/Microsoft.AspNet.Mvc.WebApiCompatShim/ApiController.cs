...
namespace System.Web.Http
{
    ...
    public abstract class ApiController : IDisposable
    {
        ...
        /// <summary>
        /// Creates a <see cref="JsonResult"/> (200 OK) with the specified value.
        /// </summary>
        ...
        [NonAction]
        public virtual JsonResult Json([NotNull] object content)
        {
        ...
        [NonAction]
        public virtual JsonResult Json([NotNull] object content, [NotNull] JsonSerializerSettings serializerSettings)
        {
