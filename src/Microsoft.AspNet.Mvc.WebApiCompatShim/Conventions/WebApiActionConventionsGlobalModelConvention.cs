...
namespace Microsoft.AspNet.Mvc.WebApiCompatShim
{
    public class WebApiActionConventionsGlobalModelConvention : IGlobalModelConvention
    {
        ...
        {
            return controller.Attributes.OfType<UseWebApiActionConventionsAttribute>().Any();
        }
        ...
        private void Apply(ControllerModel model)
        {
            ...
            {
                SetHttpMethodsFromConvention(action);
        ...
        private void SetHttpMethodsFromConvention(ActionModel action)
        {
