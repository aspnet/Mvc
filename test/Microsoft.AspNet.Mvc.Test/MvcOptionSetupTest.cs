...
namespace Microsoft.AspNet.Mvc
{
    public class MvcOptionSetupTest
    {
        ...
        public void Setup_SetsUpOutputFormatters()
        {
            ...
            Assert.IsType<XmlSerializerOutputFormatter>(mvcOptions.OutputFormatters[1].Instance);
            Assert.IsType<XmlDataContractSerializerOutputFormatter>(mvcOptions.OutputFormatters[2].Instance);
        }
    }
}