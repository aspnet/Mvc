...
namespace Microsoft.AspNet.Mvc.Test
{
    public class ProducesAttributeTests
    {
        ...
        public async Task ProducesAttribute_SetsContentType()
        {
            ...
            Assert.True(MediaTypeComparisons.AreEqual(mediaType1, objectResult.ContentTypes[0], ignoreQuality: false));
            Assert.True(MediaTypeComparisons.AreEqual(mediaType2, objectResult.ContentTypes[1], ignoreQuality: false));
        }
