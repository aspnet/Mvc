    ...
    public class DefaultTemplatesUtilities
    {
        ...
        public static HtmlHelper GetHtmlHelper(object model)
        {
            ...
            viewData.ModelMetadata =
                new EmptyModelMetadataProvider().GetMetadataForType(() => model, typeof(ObjectTemplateModel));
            ...
            view
                ...
                {
                    v.Writer.WriteAsync(FormatOutput(v.ViewData.ModelMetadata));
                })
        ...
        {
            return String.Format("Model = {0}, ModelType = {1}, PropertyName = {2}, SimpleDisplayText = {3}",
                                 metadata.Model ?? "(null)",
