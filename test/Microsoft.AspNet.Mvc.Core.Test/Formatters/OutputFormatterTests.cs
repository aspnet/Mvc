...
namespace Microsoft.AspNet.Mvc.Test
{
    public class OutputFormatterTests
    {
        ...
        public void WriteResponseContentHeaders_NoSelectedContentType_SetsOutputFormatterContext()
        {
            ...
            // Assert
            Assert.Equal(Encodings.UTF16LEEncodingWithBOM.WebName, formatterContext.SelectedEncoding.WebName);
            Assert.Equal(Encodings.UTF16LEEncodingWithBOM, formatterContext.SelectedEncoding);
            Assert.Equal("application/doesNotSetContext;charset=" + Encodings.UTF16LEEncodingWithBOM.WebName,
