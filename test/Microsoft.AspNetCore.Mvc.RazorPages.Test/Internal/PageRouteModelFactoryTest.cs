...
namespace Microsoft.AspNetCore.Mvc.RazorPages.Internal
{
    public class PageRouteModelFactoryTest
    {
        ...
        public void CreateRouteModel_AddsSelector()
        {
            ...
            Assert.Equal(routeModel.PageName, routeModel.ViewEnginePath);
            ...
            Assert.False(routeModel.IsFallbackRoute);
        }
        ...
        [Fact]
        public void CreateRouteModel_CalculatesFallbackRoutes()
        {
            // Arrange
            var relativePath = "/Pages/Users/Shared/About.cshtml";
            var options = new RazorPagesOptions();
            var routeModelFactory = new PageRouteModelFactory(options, NullLogger.Instance);
            ...
            // Assert
            Assert.Equal(relativePath, routeModel.RelativePath);
            Assert.Equal("/Users/Shared/About", routeModel.ViewEnginePath);
            Assert.Equal("/Users/About", routeModel.PageName);

            Assert.Collection(
                routeModel.Selectors,
                selector => Assert.Equal("Users/About/{id?}", selector.AttributeRouteModel.Template));
            ...
            Assert.Collection(
                ...
                {
                    Assert.Equal("page", kvp.Key);
                    Assert.Equal("/Users/About", kvp.Value);
                });
            Assert.True(routeModel.IsFallbackRoute);
        }
        ...
        [Fact]
        public void CreateAreaRouteModel_CalculatesFallbackRoute()
        {
            // Arrange
            var relativePath = "/Areas/TestArea/Pages/Shared/Profile.cshtml";
            var options = new RazorPagesOptions();
            var routeModelFactory = new PageRouteModelFactory(options, NullLogger.Instance);
            ...
            // Assert
            Assert.Equal(relativePath, routeModel.RelativePath);
            Assert.Equal("/Shared/Profile", routeModel.ViewEnginePath);
            Assert.Equal("/Profile", routeModel.PageName);

            Assert.Collection(
                routeModel.Selectors,
                selector => Assert.Equal("TestArea/Profile/{id?}", selector.AttributeRouteModel.Template));
            ...
            Assert.Collection(
                ...
                {
                    Assert.Equal("page", kvp.Key);
                    Assert.Equal("/Profile", kvp.Value);
                });
            Assert.True(routeModel.IsFallbackRoute);
        }
