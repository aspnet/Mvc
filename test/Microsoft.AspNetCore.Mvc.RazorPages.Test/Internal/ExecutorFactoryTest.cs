...
namespace Microsoft.AspNetCore.Mvc.RazorPages.Test.Internal
{
    public class ExecutorFactoryTest
    {
        ...
        public async Task CreateExecutor_ForActionResultMethod_OnPage()
        {
            ...
            // Act
            var executor = ExecutorFactory.CreateExecutor(methodInfo);
        ...
        [InlineData(nameof(TestPageModel.TaskOfObjectResult))]
        ...
        public void CreateExecutor_ThrowsIfTypeIsNotAValidReturnType(string methodName)
        {
            ...
            // Act & Assert
            var ex = Assert.Throws<InvalidOperationException>(() => ExecutorFactory.CreateExecutor(methodInfo));
        ...
        private class TestPageModel
        {
            ...
            public Task<object> TaskOfObjectResult() => Task.FromResult(new object());
