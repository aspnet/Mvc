...
namespace Microsoft.AspNetCore.Mvc.Internal
{
    public class ApiBehaviorApplicationModelProviderTest
    {
        ...
        [Fact]
        public void InferBindingSourceForParameter_ReturnsNull_IfParameterHasBindingInfo()
        {
            // Arrange
            var parameter = GetParameterModel(typeof(ParameterBindingController), nameof(ParameterBindingController.ActionWithBoundParameter));
            var provider = GetProvider();
