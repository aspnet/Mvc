...
namespace Microsoft.AspNetCore.Mvc.Internal
{
    public class AttributeRouteTest
    {
        ...
        [Fact]
        public void AttributeRoute_ThrowsRouteCreationException_ForNonExistentConstraints()
        {
            // Arrange
            var routeName = "GetBlogById";
            var routeTemplate = "api/Blog/{id:thisdoesnotexist}";
            var actions = new List<ActionDescriptor>()
            {
                new ActionDescriptor()
                {
