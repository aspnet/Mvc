...
namespace Microsoft.AspNetCore.Mvc.Razor.Internal
{
    public class CSharpCompilerTest
    {
        ...
        public void GetCompilationOptions_ReturnsDefaultOptionsIfApplicationNameIsNullOrEmpty(string name)
        {
            ...
            var compiler = CSharpCompiler.GetDependencyContextCompilationOptions(hostingEnvironment);

            // Act & Assert
            Assert.Same(DependencyContextCompilationOptions.Default, compiler);
        }
        ...
        public void GetCompilationOptions_ReturnsDefaultOptionsIfApplicationDoesNotHaveDependencyContext()
        {
            ...
            var compiler = CSharpCompiler.GetDependencyContextCompilationOptions(hostingEnvironment.Object);
        ...
        public void Constructor_SetsPreprocessorSymbols(string environment, string expectedConfiguration)
        {
            // Arrange
            var options = new RazorViewEngineOptions();
            var hostingEnvironment = new Mock<IHostingEnvironment>();
        ...
        [Fact]
        public void Constructor_ConfiguresDefaultCompilationOptions()
        {
            // Arrange
        ...
        [Fact]
        public void Constructor_ConfiguresDefaultParseOptions()
        {
            // Arrange
            var hostingEnvironment = Mock.Of<IHostingEnvironment>(h => h.EnvironmentName == "Development");
            var compiler = new CSharpCompiler(Mock.Of<RazorReferenceManager>(), hostingEnvironment);
            ...
            // Act & Assert
            var parseOptions = compiler.ParseOptions;
            Assert.Equal(LanguageVersion.CSharp7_1, parseOptions.LanguageVersion);
        ...
        public void Constructor_ConfiguresAllowUnsafe()
        {
            ...
            var compiler = new CSharpCompiler(referenceManager, hostingEnvironment, dependencyContextOptions);
