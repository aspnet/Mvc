...
namespace Microsoft.AspNet.Mvc.IntegrationTests
{
    public class ValidationIntegrationTests
    {
        ...
        [Fact(Skip = "Extra ModelState key because of #2446")]
        public async Task Validation_StringLengthAttribute_OnPOCOProperty_Valid()
        {
            // Arrange
            var argumentBinder = ModelBindingTestHelper.GetArgumentBinder();
            var parameter = new ParameterDescriptor()
        ...
        [Fact(Skip = "Extra ModelState key because of #2446")]
        public async Task Validation_StringLengthAttribute_OnPOCOProperty_Invalid()
        {
            // Arrange
            var argumentBinder = ModelBindingTestHelper.GetArgumentBinder();
            var parameter = new ParameterDescriptor()
        ...
        [Fact(Skip = "Extra ModelState key because of #2446")]
        public async Task Validation_StringLengthAttribute_OnCollectionElement_Valid()
        {
            // Arrange
            var argumentBinder = ModelBindingTestHelper.GetArgumentBinder();
            var parameter = new ParameterDescriptor()
        ...
        [Fact(Skip = "Extra ModelState key because of #2446")]
        public async Task Validation_StringLengthAttribute_OnCollectionElement_Invalid()
        {
            // Arrange
            var argumentBinder = ModelBindingTestHelper.GetArgumentBinder();
            var parameter = new ParameterDescriptor()
