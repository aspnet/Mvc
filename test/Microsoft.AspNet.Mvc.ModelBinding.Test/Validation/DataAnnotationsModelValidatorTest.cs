...
namespace Microsoft.AspNet.Mvc.ModelBinding.Test.Validation
{
    public class DataAnnotationsModelValidatorTest
    {
        ...
        public void ValidateWithIsValidTrue()
        {
            ...
            // Act
            IEnumerable<ModelValidationResult> result = validator.Validate(validationContext);
        ...
        public void ValidateReturnsSingleValidationResultIfMemberNameSequenceIsEmpty()
        {
            ...
            // Act
            IEnumerable<ModelValidationResult> results = validator.Validate(validationContext);
