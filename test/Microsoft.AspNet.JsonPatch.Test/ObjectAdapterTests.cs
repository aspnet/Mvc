...
namespace Microsoft.AspNet.JsonPatch.Test
{
    public class ObjectAdapterTests
    {
        ...
        public void AddToListInvalidPositionTooLarge()
        {
            ...
            Assert.Equal("For Operation 'add', array property at location path: '/integerlist/4' index is " +
        ...
        public void RemoveFromListInvalidPositionTooLarge()
        {
            ...
            // Act & Assert
            var exception = Assert.Throws<JsonPatchException<SimpleDTO>>(() => { patchDoc.ApplyTo(doc); });
            Assert.Equal("For Operation 'remove', array property at location path: '/integerlist/3' index is " +
                "larger than array size.", exception.Message);
        }
        ...
        public void ReplaceInListInvalidInvalidPositionTooLarge()
        {
            ...
            Assert.Equal("For Operation 'replace', array property at location path: '/integerlist/3' index is " +
                "larger than array size.", exception.Message);
        }
