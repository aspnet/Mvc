    ...
    public class DefaultHtmlGeneratorTest
    {
        ...
        public void GetCurrentValues_AllowMultipleWithNonEnumerableInViewData_Throws(object value)
        {
            ...
            var exception = Assert.Throws<InvalidOperationException>(() => htmlGenerator.GetCurrentValues(
                ...
                allowMultiple: true));
            Assert.Equal(
                "The parameter 'expression' must evaluate to an IEnumerable or an Enum with an " +
                "associated FlagsAttribute when multiple selection is allowed.",
                exception.Message);
        }
        ...
        public static TheoryData<string, object, string[]> GetCurrentValues_ValueToConvertData
        {
            get
            {
                return new TheoryData<string, object, string[]>
                {
                    ...
                    { nameof(Model.FlagsEnum), "Two, Four", new [] { "6", "Two, Four" } },
                    ...
                    { nameof(Model.NullableEnum), "One, Two", new [] { "3", "Three", "One, Two" } },
                    ...
                    { nameof(Model.RegularEnum), "One, Two", new [] { "3", "Three", "One, Two" } },
