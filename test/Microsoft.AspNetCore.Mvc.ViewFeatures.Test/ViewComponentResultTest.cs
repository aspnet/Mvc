...
namespace Microsoft.AspNetCore.Mvc
{
    public class ViewComponentResultTest
    {
        ...
        {
            // Arrange
            var expected = "A view component named 'Text' could not be found. View components must be a Public non-generic concrete type, not contain generic parameters and use ViewComponentAttribute or have a class name ending with 'ViewComponent'.";
        ...
        {
            // Arrange
            var expected = $"A view component named '{typeof(TextViewComponent).FullName}' could not be found. View components must be a Public non-generic concrete type, not contain generic parameters and use ViewComponentAttribute or have a class name ending with 'ViewComponent'.";
