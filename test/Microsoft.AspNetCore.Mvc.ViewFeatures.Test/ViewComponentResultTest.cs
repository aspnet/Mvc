...
namespace Microsoft.AspNetCore.Mvc
{
    public class ViewComponentResultTest
    {
        ...
        {
            // Arrange
            var expected = "A view component named 'Text' could not be found. View components should be a public concrete non-generic class, and should be decorated with ViewComponentAttribute or have a class name ending in 'ViewComponent'. The class cannot be decorated with NonViewComponentAttribute.";
        ...
        {
            // Arrange
            var expected = $"A view component named '{typeof(TextViewComponent).FullName}' could not be found. View components should be a public concrete non-generic class, and should be decorated with ViewComponentAttribute or have a class name ending in 'ViewComponent'. The class cannot be decorated with NonViewComponentAttribute.";
