...
namespace Microsoft.AspNetCore.Mvc.TagHelpers
{
    public class TagHelperOutputExtensionsTest
    {
        ...
        [Fact]
        public void AddClass_Single_TagHelperOutputAttributeValues()
        {
            // Arrange
            var expectedValue = "btn";
            ...
            // Act
            tagHelperOutput.AddClass("btn");

            // Assert
            var classAttribute = Assert.Single(tagHelperOutput.Attributes, attr => attr.Name.Equals("class"));
            Assert.Equal(expectedValue, classAttribute.Value);
        }

        [Fact]
        public void AddClass_Multiple_TagHelperOutputAttributeValues()
        {
            // Arrange
            var expectedValue = "btn btn-primary";
            ...
            // Act
            tagHelperOutput.AddClass("btn");
            tagHelperOutput.AddClass("btn-primary");
        ...
        [Fact]
        public void RemoveClass_Single_TagHelperOutputAttributeValues()
        {
            // Arrange
            var expectedValue = "btn";
            ...
            var tagHelperOutput = new TagHelperOutput(
                ...
                getChildContentAsync: (useCachedResult, encoder) => Task.FromResult<TagHelperContent>(
                    new DefaultTagHelperContent()));
            tagHelperOutput.Attributes.Add("class", "btn btn-primary");

            // Act
            tagHelperOutput.RemoveClass("btn-primary");
        ...
        [Fact]
        public void RemoveClass_Multiple_TagHelperOutputAttributeValues()
        {
            // Arrange
            var expectedValue = "btn";
            ...
            var tagHelperOutput = new TagHelperOutput(
                ...
                getChildContentAsync: (useCachedResult, encoder) => Task.FromResult<TagHelperContent>(
                    new DefaultTagHelperContent()));
            tagHelperOutput.Attributes.Add("class", "btn btn-success btn-primary btn-success");

            // Act
            tagHelperOutput.RemoveClass("btn-success");
            tagHelperOutput.RemoveClass("btn-primary");
