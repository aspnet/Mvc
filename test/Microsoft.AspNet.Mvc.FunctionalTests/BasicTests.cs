...
namespace Microsoft.AspNet.Mvc.FunctionalTests
{
    public class BasicTests : IClassFixture<MvcFixture<BasicWebSite.Startup>>
    {
        ...
        public async Task CanRender_SimpleViews()
        {
            ...
            // Act
            var response = await Fixture.Client.GetAsync("http://localhost/Home/PlainView");
            var responseContent = await response.Content.ReadAsStringAsync();
        ...
        public async Task ViewWithAttributePrefix_RendersWithoutIgnoringPrefix()
        {
            ...
            // Act
            var response = await Fixture.Client.GetAsync("Home/ViewWithPrefixedAttributeValue");
            var responseContent = await response.Content.ReadAsStringAsync();
        ...
        {
            // Act
            var response = await Fixture.Client.GetAsync("Home/NoContentResult");
            var responseContent = await response.Content.ReadAsStringAsync();
        ...
        {
            // Act
            var response = await Fixture.Client.GetAsync("Home/ActionReturningTask");
        ...
        public async Task ActionDescriptors_CreatedOncePerRequest()
        {
            ...
            for (var i = 0; i < 3; i++)
            {
                var result = await Fixture.Client.GetAsync("Monitor/CountActionDescriptorInvocations");
        ...
        {
            // Act
            var response = await Fixture.Client.GetAsync("Home/HttpsOnlyAction");
        ...
        public async Task JsonViewComponent_RendersJson()
        {
            ...
            // Act
            var response = await Fixture.Client.GetAsync("Home/JsonTextInView");
    ...
    var json = {0};
            ...
            // Act
            var response = await Fixture.Client.GetAsync("Home/JsonHelperInView");
    ...
    var json = {0};
            ...
            // Act
            var response = await Fixture.Client.GetAsync("Home/JsonHelperWithSettingsInView");
        ...
        {
            // Act
            var response = await Fixture.Client.GetAsync("Links/Index?view=" + viewName);
        ...
        {
            // Act
            var response = await Fixture.Client.GetAsync("Home/GetApplicationDescription");
        ...
        {
            // Act
            var response = await Fixture.Client.GetStringAsync("appointments");
        ...
        {
            // Act
            var response = await Fixture.Client.GetAsync("SqlData/TruncateAllDbRecords");
