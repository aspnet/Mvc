...
namespace Microsoft.AspNet.Mvc.FunctionalTests
{
    public class TagHelpersTests
    {
        ...
        [InlineData("http://localhost/Home/", "About")]
        [InlineData("http://localhost/Home/", "Help")]
        public async Task CanRenderViewsWithTagHelpers(string url, string action)
        {
            // Arrange
            ...
            var response = await client.GetAsync(url + action);
