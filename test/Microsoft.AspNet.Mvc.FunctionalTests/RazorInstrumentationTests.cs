...
namespace Microsoft.AspNet.Mvc.FunctionalTests
{
    ...
    {
        private readonly IServiceProvider _services = TestHelper.CreateServices("RazorInstrumentationWeb");
        ...
        private IServiceProvider GetServiceProvider(TestPageExecutionContext pageExecutionContext)
        {
            ...
            return TestHelper.CreateServices("RazorInstrumentationWeb", services);
        }
    }
}