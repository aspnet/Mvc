...
namespace Microsoft.AspNet.Mvc.FunctionalTests
{
    public class FlushPointTest
    {
        ...
        [Theory]
        [InlineData("PageWithPartialsAndViewComponents")]
        [InlineData("PageWithRenderSectionAsync")]
        public async Task FlushPointsAreExecutedForPagesWithComponentsPartialsAndSections(string action)
        {
            var waitService = new WaitService();
            var serviceProvider = GetServiceProvider(waitService);
