...
namespace MvcSample.Web.Components
{
    ...
    public class TagCloudViewComponentTagHelper : ViewComponent, ITagHelper, ICanHasViewContext
    {
        ...
        public async Task ProcessAsync(TagHelperOutput output, TagHelperContext context)
        {
