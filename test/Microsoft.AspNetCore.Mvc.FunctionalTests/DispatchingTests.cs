...
{
    public class DispatchingTests : IClassFixture<MvcTestFixture<DispatchingWebSite.Startup>>
    {
        public DispatchingTests(MvcTestFixture<DispatchingWebSite.Startup> fixture)
        {
