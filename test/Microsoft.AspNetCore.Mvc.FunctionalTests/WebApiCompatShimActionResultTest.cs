...
namespace Microsoft.AspNetCore.Mvc.FunctionalTests
{
    public class WebApiCompatShimActionResultTest : IClassFixture<MvcTestFixture<WebApiCompatShimWebSite.Startup>>
    {
        ...
        [Fact]
        public async Task ApiController_AcceptedRelative()
        {
            // Arrange & Act
            var response = await Client.GetAsync("http://localhost/api/Blog/ActionResult/GetAcceptedRelative");
            var content = await response.Content.ReadAsStringAsync();
        ...
        [Fact]
        public async Task ApiController_AcceptedAbsolute()
        {
            // Arrange & Act
            var response = await Client.GetAsync("http://localhost/api/Blog/ActionResult/GetAcceptedAbsolute");
            var content = await response.Content.ReadAsStringAsync();
        ...
        [Fact]
        public async Task ApiController_AcceptedQualified()
        {
            // Arrange & Act
            var response = await Client.GetAsync("http://localhost/api/Blog/ActionResult/GetAcceptedQualified");
            var content = await response.Content.ReadAsStringAsync();
        ...
        [Fact]
        public async Task ApiController_AcceptedUri()
        {
            // Arrange & Act
            var response = await Client.GetAsync("http://localhost/api/Blog/ActionResult/GetAcceptedUri");
            var content = await response.Content.ReadAsStringAsync();
        ...
        [Fact]
        public async Task ApiController_AcceptedAtRoute()
        {
            // Arrange & Act
            var response = await Client.GetAsync("http://localhost/api/Blog/ActionResult/GetAcceptedAtRoute");
            var content = await response.Content.ReadAsStringAsync();
